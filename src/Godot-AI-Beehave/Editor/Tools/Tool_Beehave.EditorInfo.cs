...
namespace com.IvanMurzak.Godot.MCP.Beehave
{
    public partial class Tool_Beehave
    {
        ...
        public const string EditorInfoToolId = "beehave-editor-info";
        ...
        /// beehave-editor-info</c>), NOT by the pure-managed unit tests — a plain xUnit host
        ...
        (
            EditorInfoToolId,
            Title = "Beehave Tools / Editor Info",
            ReadOnlyHint = true,
            IdempotentHint = true,
            OpenWorldHint = false
        )]
        [Description("Sample editor-only tool for the Beehave Tools extension. Returns the running " +

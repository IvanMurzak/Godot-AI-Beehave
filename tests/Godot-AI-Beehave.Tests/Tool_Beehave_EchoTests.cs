...
namespace com.IvanMurzak.Godot.MCP.Beehave.Tests
{
    ...
    /// PURE-MANAGED sample tool <c>beehave-echo</c> by constructing the tool family and
    ...
    /// </summary>
    public class Tool_Beehave_EchoTests
    {
        [Fact]
        ...
        {
            var tool = new Tool_Beehave();
            Assert.Equal("beehave-ready", tool.Echo(message));
        }
        ...
        public void EchoToolId_IsStable()
        {
            ...
            Assert.Equal("beehave-echo", Tool_Beehave.EchoToolId);
        }
    }
}
